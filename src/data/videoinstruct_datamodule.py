...
from .components.videoinstruct_dataset import VIDEOINSTRUCT
...
class VIDEOINSTRUCTDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            self.data_train = VIDEOINSTRUCT(self.hparams.text_dir, self.hparams.video_dir, self.hparams.of_dir, nframe=self.hparams.nframe, split='train', processor=self.processor, sampler_processor=self.sampler_processor, video_transform=self.videotransforms, image_transform=self.imagetransforms)
            self.data_val = VIDEOINSTRUCT(self.hparams.text_dir, self.hparams.video_dir, self.hparams.of_dir, nframe=self.hparams.nframe, split='val', processor=self.processor, sampler_processor=self.sampler_processor, video_transform=self.videotransforms, image_transform=self.imagetransforms)
            self.data_test = VIDEOINSTRUCT(self.hparams.text_dir, self.hparams.video_dir, self.hparams.of_dir, nframe=self.hparams.nframe, split='test', processor=self.processor, sampler_processor=self.sampler_processor, video_transform=self.videotransforms, image_transform=self.imagetransforms)
